            ...
            <div class="col-md-9">
              ...
              <article class="card mb-4">
                <header class="card-header text-center">
                  <div class="card-meta">
                    <a href="#"><time class="timeago" datetime="2021-09-21 20:00">21 october 2021</time></a> in <a  href="{{ route('post-category') }}" wire:navigate>Journey</a>
                  </div>
                ...
                <a href="post-image.html">
                  <div class="vimeo">
                    <iframe src="video/203710832?title=0&byline=0&portrait=0" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                  </div>
                </a>
                <div class="card-body">
